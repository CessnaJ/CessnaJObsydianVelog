      ...
      {!menuOpen && (
        <>
          <ul className=" justify-evenly w-2/4 my-auto hidden md:flex">
            <li>
              <span className=" hover:font-semibold hover:underline  text-xl font-medium text-gray-800">
                <Link href="/posts">All posts</Link>
              </span>
            </li>
            <li>
              <button
                className="hover:font-semibold  text-xl font-medium text-gray-800 px-4 text-center inline-flex items-center "
                type="button"
              ...
              {showDropDown && (
                <div className=" font-semibold text-gray-600 absolute bg-white  z-50 list-none divide-y divide-gray-100 rounded-md w-[200px]  shadow-xl my-4 animate-fade-in-down">
                  <ul className="py-1">
                    <li>
                      <span
                        className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer"
                        onClick={() => handleRoute("react-js")}
                      >
                        React js{" "}
                      </span>
                    </li>
                    <li>
                      <span
                        className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer"
                        onClick={() => handleRoute("react-native")}
                      >
                        React Native
                      </span>
                    </li>
                    <li>
                      <span
                        className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer"
                        onClick={() => handleRoute("vanilla-js")}
                      >
                        Vanilla js
                      </span>
                    </li>
                    ...
                    <li>
                      <span
                        className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer"
                        onClick={() => handleRoute("typescript")}
                      >
                        Typescript
                      </span>
                    </li>
          ...
          <div className="justify-evenly w-1/6 my-auto hidden md:flex">
            <span className=" hover:font-semibold hover:underline text-xl font-medium text-gray-800">
              <a href="https://twitter.com/asofex">
                <AiOutlineTwitter className="w-7 h-7 my-auto mx-1" />
              </a>
            </span>
            <span className=" hover:font-semibold hover:underline text-xl font-medium text-gray-800">
              <a href="https://github.com/CessnaJ">
                <AiOutlineGithub className="w-7 h-7 my-auto mx-1" />
              </a>
            </span>
          </div>
        </>
      ...
      {menuOpen && (
        <MobileMenu>
          <ul className="list-none ">
            <li className="my-4">
              <span
                className=" hover:text-black hover:underline focus:underline text-xl font-bold text-gray-700"
                onClick={() => setMenuOpen(!menuOpen)}
              >
                <Link href="/posts">All posts</Link>
              </span>
          ...
          <div className="flex justify-evenly w-1/4 md:w-1/6 my-auto  mx-auto">
            ...
            <span className=" hover:font-semibold hover:underline text-xl font-medium text-gray-800">
              <a href="https://github.com/teyim/Nextjs-markdown-blog">
                <AiOutlineGithub className="w-7 h-7 my-auto mx-1" />
              </a>
            </span>
          </div>
